...
static LOCALE: Lazy<HashMap<&'static str, HashMap<&'static str, &'static str>>> = Lazy::new(|| HashMap::from([
    ...
    ("bootstrap.no-bootstrap", [("zh-CN", "不使用启动程序"), ("en-US", "Bootstrap program not used")].into()),
    ...
    ("platform-support.sophgo-2002-series", [("zh-CN", "算能® SG2002 系列平台"), ("en-US", "Sophgo® SG2002 series")].into()),
    ...
    ("platform-support.no-specific-platform", [("zh-CN", "未指定平台"), ("en-US", "No platform speficied")].into()),
    ("allwinner-d1-series.title", [("zh-CN", " RustSBI 原型设计系统 - 全志® D1-H 系列平台 "), ("en-US", " RustSBI Prototyping System - Allwinner® D1-H series ")].into()),
    ("sophgo-2002-series.title", [("zh-CN", " RustSBI 原型设计系统 - 算能® SG2002 系列平台 "), ("en-US", " RustSBI Prototyping System - Sophgo® SG2002 series ")].into()),
    ...
    ("standard-sbi-features.dbcn", [("zh-CN", "调试控制台扩展"), ("en-US", "Debug console extension")].into()),
    ("standard-sbi-features.susp", [("zh-CN", "系统挂起扩展"), ("en-US", "System suspend extension")].into()),
    ("standard-sbi-features.cppc", [("zh-CN", "性能控制扩展"), ("en-US", "Collaborative Processor Performance Control extension")].into()),
    ("standard-sbi-features.nacl", [("zh-CN", "嵌套加速扩展"), ("en-US", "Nested acceleration extension")].into()),
    ("standard-sbi-features.sta", [("zh-CN", "Steal-time 计算扩展"), ("en-US", "Steal-time accounting extension")].into()),
