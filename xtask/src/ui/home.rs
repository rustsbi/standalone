    ...
    B: Backend,
{
    ...
    let items = vec![
        ...
        vec!["Bootstrap".to_string(), "home.bootstrap".to_string(), app.bootstrap_brief(), ">".to_string()],
        ...
        vec!["PlatformSupport".to_string(), "home.platform-support".to_string(), app.platform_support_brief(), ">".to_string()],
        ...
        vec!["QuitAndSave".to_string(), "home.quit-and-save".to_string(), "".to_string(), "".to_string()],
    ];
